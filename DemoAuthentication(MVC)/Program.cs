using DemoAuthentication_MVC_.Data;
...
//    .AddEntityFrameworkStores<DemoAuthentication_MVC_Context>();
...
{
    options.AddPolicy("readonly", policy => policy.RequireRole("Admin", "HR"));
